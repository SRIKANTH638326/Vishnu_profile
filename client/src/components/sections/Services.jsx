                    ...
                    <div style={{ width: "100%", maxWidth: hideImage ? "800px" : "none" }}>
                        ...
                        >
                            ...
                            <p style={{ color: "var(--secondary-text)", fontSize: "clamp(0.95rem, 1.1vw, 1.2rem)", lineHeight: 1.6, maxWidth: 480, marginBottom: 60 }}>
                                As a UI/UX designer, I am a visual storyteller, crafting experiences that connect deeply and spark creativity
                            </p>
                        </motion.div>
                    ...
                    >
                        <div style={{ paddingTop: 24, paddingLeft: 56 }}>
                            {(service.description || service.desc) && (
                                <p style={{ color: "var(--secondary-text)", fontSize: "0.95rem", lineHeight: 1.6, marginBottom: 20 }}>
                                    {service.description || service.desc}
                                </p>
                            )}
