...
const categories = ["Design Tools", "Frontend","Backend","Databases","Data & Analytics", "Other"];
...
export const ManageSkills = () => {
  ...
  const [form, setForm] = useState({ name: "", description: "", pct: 80, category: "Frontend", color: "#82f163ff" });
          ...
          <div style={{ display: "grid", gap: "24px" }}>
            <div style={{ display: "grid", gridTemplateColumns: width < 640 ? "1fr" : "1.5fr 1fr", gap: "20px" }}>
              ...
              <div style={inputGroupStyle}>
                ...
                <select value={form.category} onChange={e => setForm({ ...form, category: e.target.value })} style={{ ...inputStyle, background: "#161616" }}>
                  {categories.map(c => <option key={c} value={c} style={{ background: "#161616", color: "#fff" }}>{c}</option>)}
                </select>
              </div>
            </div>
