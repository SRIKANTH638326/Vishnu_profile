...
export function About({ hideImage = false, isHome = false }) {
    const stats = [
        ...
        { label: "Completed Projects", value: "270" },
        { label: "Clients on Worldwide", value: "50+" },
    ];
                        ...
                        >
                            ...
                            <div style={{ maxWidth: isHome ? "600px" : "540px" }}>
                                <p style={{
                                    ...
                                    {isHome ? (
                                        "Hi, I'm Srikanth — a digital designer and Framer developer passionate about crafting meaningful and impactful digital experiences."
                                    ) : (
                                        <>
                                ...
                                <>
                                    ...
                                    <div style={{ display: "flex", gap: 60, flexWrap: "wrap", marginBottom: 24 }}>
                                        <div>
                                            ...
                                            <div style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.6)" }}>+91 9390234567</div>
                                        </div>
                                        <div>
                                            <div style={{ fontSize: "1rem", fontWeight: 700, color: "#fff", marginBottom: 8 }}>Email :</div>
                                            <div style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.6)" }}>srikanthc061@gmail.com</div>
                                        </div>
                                    </div>
                                </>
                            )}
