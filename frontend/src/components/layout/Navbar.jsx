                    ...
                    <AnimatePresence mode="popLayout" initial={false}>
                        {!menuOpen ? (
                            ...
                            >
                                ...
                                <motion.div
                                    layout
                                    style={{ width: isMobile ? 1 : 0, height: 20, background: "var(--border)", margin: isMobile ? "0 8px" : 0, opacity: isMobile ? 1 : 0 }}
                                />

                                {/* Main Pill Content */}
                                <motion.div layout style={{ display: "flex", alignItems: "center", flex: 1, justifyContent: isMobile ? "flex-start" : "center" }}>
